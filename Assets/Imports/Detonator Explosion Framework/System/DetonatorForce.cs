        ...
        if (_explodeDelay <= 0) //if the delayTime is zero
        {
            ...
            foreach (Collider hit in _colliders)
            {
                ...
                if (hit.GetComponent<Rigidbody>())
                {
                    ...
                    hit.GetComponent<Rigidbody>().AddExplosionForce((power * size), _explosionPosition, (radius * size),
                    ...
                    if (fireObject)
                    {
                        ...
                        _tempFireObject =
                            (Instantiate(fireObject, this.transform.position, this.transform.rotation)) as GameObject;
