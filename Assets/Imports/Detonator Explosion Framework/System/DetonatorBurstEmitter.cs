...
public class DetonatorBurstEmitter : DetonatorComponent
{
    ...
    private float
        _tmpAngularVelocity; //random angular velocity from -angularVelocity to +angularVelocity, if randomRotation is true;
        ...
        if (on)
        {
            ...
            if (_explodeDelay <= 0)
            {
                if (useExplicitColorAnimation)
                {
                    ...
                    {
                        _psCoLGradientColor[i] =
                            new GradientColorKey(colorAnimation[i], (timeDivision * i) + timeDivision);
                        _psCoLGradientAlpha[i] =
                            new GradientAlphaKey(colorAnimation[i].a, (timeDivision * i) + timeDivision);
                    }
                ...
                else //auto fade
                {
                    ...
                    _psCoLGradientAlpha = new GradientAlphaKey[]
                    {
                        new GradientAlphaKey(color.a * .7f, timeDivision * 0),
                ...
                {
                    _tmpPos = Vector3.Scale(Random.insideUnitSphere,
