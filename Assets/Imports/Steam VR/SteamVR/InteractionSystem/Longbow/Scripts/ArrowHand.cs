...
namespace Valve.VR.InteractionSystem
{
    ...
    public class ArrowHand : MonoBehaviour
    {
        ...
        {
            GameObject arrow =
                Instantiate(arrowPrefab, arrowNockTransform.position, arrowNockTransform.rotation) as GameObject;
        ...
        private void HandAttachedUpdate(Hand hand)
        {
            ...
            if (!nocked)
            {
                ...
                {
                    float lerp = Util.RemapNumber(distanceToNockPosition, rotationLerpThreshold, lerpCompleteDistance,
                        0, 1);
