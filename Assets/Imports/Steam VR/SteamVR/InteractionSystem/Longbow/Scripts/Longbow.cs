    ...
    public class Longbow : MonoBehaviour
    {
        ...
        private void HandAttachedUpdate(Hand hand)
        {
            ...
            if (nocked)
            {
                ...
                float lerp = Util.RemapNumberClamped(Time.time, nockLerpStartTime, (nockLerpStartTime + lerpDuration),
                    0f, 1f);
                ...
                if (Vector3.Dot(nockToarrowHand, -nockTransform.forward) > 0)
                {
                    ...
                    this.bowDrawLinearMapping.value =
                    ...
                    {
                        ushort hapticStrength = (ushort) Util.RemapNumber(nockDistanceTravelled, 0, maxPull,
