...
namespace Valve.VR
{
        ...
        ISteamVR_Action_Skeleton_Source, ISerializationCallbackReceiver
    {
        ...
        {
            get { return sourceMap[SteamVR_Input_Sources.Any].onlyUpdateSummaryData; }
    ...
    public class SteamVR_Action_Skeleton_Source_Map : SteamVR_Action_Pose_Source_Map<SteamVR_Action_Skeleton_Source>
    {
        ...
        {
            return sources
                [0]; //just in case somebody tries to access a different element, redirect them to the correct one.
        }
    }
    ...
    public class SteamVR_Action_Skeleton_Source : SteamVR_Action_Pose_Source, ISteamVR_Action_Skeleton_Source
    {
                ...
                if (delegates != null)
                    foreach (Delegate existingDelegate in delegates)
                        onDeviceConnectedChanged -=
                            (SteamVR_Action_Skeleton.DeviceConnectedChangeHandler) existingDelegate;
            }
        }
        ...
        protected VRSkeletalSummaryData_t GetSkeletalSummaryData(
            EVRSummaryType summaryType = EVRSummaryType.FromAnimation, bool force = false)
        {
        ...
        /// Easier access at named members: indexCurl, ringSplay, etc.
        /// </summary>
        protected void UpdateSkeletalSummaryData(EVRSummaryType summaryType = EVRSummaryType.FromAnimation,
            bool force = false)
        {
