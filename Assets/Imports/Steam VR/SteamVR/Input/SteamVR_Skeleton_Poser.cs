    ...
    public class SteamVR_Skeleton_Poser : MonoBehaviour
    {
        ...
        public void SetBlendingBehaviourValue(string behaviourName, float value)
        {
            ...
            if (behaviour != null)
            {
                ...
                {
                    Debug.LogWarning(
                        "[SteamVR] Blending Behaviour: " + behaviourName +
                        " is not a manual behaviour. Its value will likely be overriden.", this);
                }
            }
        }
        ...
        protected PoseBlendingBehaviour FindBlendingBehaviour(string behaviourName, bool throwErrors = true)
        {
            ...
            if (behaviour == null)
            {
                if (throwErrors)
                    Debug.LogError(
                        "[SteamVR] Blending Behaviour: " + behaviourName + " not found on Skeleton Poser: " +
